...
use Widop\GoogleAnalytics;

// ...
```

The Wid'op Google Analytics library follows the [PSR-0 Standard](https://github.com/php-fig/fig-standards/blob/master/accepted/PSR-0.md).
